...
/*   Updated: 2018/06/01 19:42:58 by lterrail         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_tab_color2(t_printf *pf, int *ret)
{
	if (ft_strncmp("light gray", pf->color, ft_strlen("light gray")) == 0)
		my_putstr("\e[90m");
	else if (ft_strncmp("light red", pf->color, ft_strlen("light red")) == 0)
		my_putstr("\e[91m");
	else if (ft_strncmp("light green", pf->color, ft_strlen("light green")) == 0)
		my_putstr("\e[92m");
	else if (ft_strncmp("light yellow", pf->color, ft_strlen("light yellow")) == 0)
		my_putstr("\e[93m");
	else if (ft_strncmp("light blue", pf->color, ft_strlen("light blue")) == 0)
		my_putstr("\e[94m");
	else if (ft_strncmp("light magenta", pf->color, ft_strlen("light magenta")) == 0)
		my_putstr("\e[95m");
